...
gulp.task('default', gulp.series(gulp.parallel('optimizeimg', 'webpImage', 'clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'fileinclude', 'scss', 'js', 'jsPages', 'html',), gulp.parallel('purgecss')));